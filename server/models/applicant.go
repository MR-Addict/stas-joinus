...
type Applicant struct {
	...
	First_Choice     string             `json:"first_choice" validate:"required,min=5,max=7,nefield=Second_Choice"`
	Second_Choice    string             `json:"second_choice" validate:"required,min=5,max=7,nefield=First_Choice"`
	Allow_Adjustment bool               `json:"allow_adjustment" validate:"required"`
}
